...
export type ChatEvent =
  ...
  | { kind: "jev"; key: string; result: string; probability?: string; tone: "yes" | "no" | "neutral"; context?: string }
  ...
  if (evt.kind === "jev") {
    ...
    return (
      <Box flexDirection="column">
        ...
        {evt.context && <Text color={mutedColor} dimColor>  context: {evt.context}</Text>}
      </Box>
    );
  }
  if (evt.kind === "memory") {
